...
export const PLAN_SECTIONS: PlanSection[] = [
  {
    ...
    title: 'ثبت فاکتور',
    description:
      'ثبت فاکتور‌ها امکان تحلیل و بررسی درآمد و مشتریان برتر را فراهم می‌کند؛ شما می‌توانید فاکتورها را از طریق اکسل، به طور مستقیم از سایت، و یا از طریق بات تلگرام شاپیک ثبت کنید.',
