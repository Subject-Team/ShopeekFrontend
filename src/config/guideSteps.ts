  ...
  dashboard: {
    ...
    steps: [
...

      {
        ...
        description: 'نام طرح، اعتبار دوره و اعتبار خریداری‌شده، پیشرفت دوره و مصرف سهمیه‌های امروز (فاکتور و هوش مصنوعی) در این کارت نمایش داده می‌شود. برای جزئیات کامل به صفحه اشتراک و پرداخت بروید.',
        placement: 'top',
      },
      {
