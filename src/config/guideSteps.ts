  ...
  dashboard: {
    ...
    steps: [
      ...
      },
      {
        ...
        tips: ['با دکمه «بروزرسانی»، می‌توانید تحلیل جدیدی درخواست کنید.'],
        placement: 'bottom',
      },
      {
        id: 'date-filter',
      ...
      },
      {
        ...
        description: 'تعداد روزهای باقی‌مانده از اشتراک شما در این بخش قابل مشاهده است. در ۷ روز پایانی، بنر هشدار تمدید نمایش داده می‌شود. پس از انقضا، دسترسی به داشبورد متوقف خواهد شد و برای تمدید می‌توانید از صفحه تماس با ما اقدام کنید.',
        tips: ['حساب‌های دمو و مدیران دارای اشتراک نامحدود هستند.'],
        placement: 'top',
      },
      {
  ...
  ingestion: {
    ...
    steps: [
      ...
      },
      {
        ...
        tips: ['پشتیبانی از تاریخ‌های شمسی مثل «امروز»، «فردا» یا ۱۴۰۵-۰۵-۱۱.'],
        placement: 'top',
      },
    ],
  },
