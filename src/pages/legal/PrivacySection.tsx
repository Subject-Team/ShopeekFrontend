  ...
  return (
    <div className="space-y-6 text-sm text-slate-700 leading-relaxed font-normal">
      ...
      <Section title="هوش مصنوعی">
        <p className="text-slate-600 text-xs leading-relaxed">
          داده‌ها برای تحلیل به تأمین‌کنندگان معتبر بین‌المللی ارسال می‌شود. طبق قرارداد، استفاده از داده‌های شما برای آموزش مدل‌ها ممنوع است و داده‌ها پس از پردازش نزد آن‌ها نگهداری نمی‌شود.
        </p>
      </Section>
