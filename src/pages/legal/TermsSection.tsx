  ...
  return (
    <div className="space-y-6 text-sm text-slate-700 leading-relaxed font-normal">
      ...
      <Section title="اعتبار و سهمیه">
        <p className="text-slate-600 text-xs leading-relaxed">
          اگر از سهمیه پلن عبور کنید، ابتدا از اعتبار ماهانه کسر می‌شود و بعد از اعتبار خریداری‌شده.
        </p>
        <p className="text-slate-600 text-xs leading-relaxed">
        ...
        <p className="text-slate-600 text-xs leading-relaxed">
          مانده اعتبار ماهانه به دوره بعد منتقل نمی‌شود. اعتبار خریداری‌شده تا زمانی که مصرف شود، معتبر است.
        </p>
      </Section>
