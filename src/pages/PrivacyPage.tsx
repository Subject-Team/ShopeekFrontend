    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-vazir dir-rtl selection:bg-brand-500 selection:text-white">
      ...
      <header className="w-full border-b border-slate-800 bg-slate-950/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-xs font-semibold text-slate-300 hover:text-white px-3 py-2 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition-all"
          >
      ...
      {/* Main Privacy Policy Article Container */}
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full space-y-8">
        ...
        <div className="space-y-8 text-sm text-slate-300 leading-relaxed font-normal">
          {/* Section 1 */}
          <section className="bg-slate-900/60 p-6 rounded-2xl border border-slate-800/80 space-y-2">
          ...
          <section className="bg-slate-900/60 p-6 rounded-2xl border border-slate-800/80 space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-xs text-slate-400 mr-2">
          ...
          <section className="bg-slate-900/60 p-6 rounded-2xl border border-slate-800/80 space-y-2">
            ...
            <ul className="space-y-3 text-xs text-slate-400">
              <li>
                <strong className="text-slate-200 block mb-0.5">• حذف اطلاعات هویتی (PII):</strong>
              ...
              <li>
                <strong className="text-slate-200 block mb-0.5">• بهینه‌سازی هزینه و کارایی:</strong>
              ...
              <li>
                <strong className="text-slate-200 block mb-0.5">• بازرسی با اجازه کاربر:</strong>
          ...
          <section className="bg-slate-900/60 p-6 rounded-2xl border border-slate-800/80 space-y-2">
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              <li><strong className="text-slate-200">• درخواست حذف:</strong> شما می‌توانید در هر زمان درخواست حذف کامل داده‌های خود را صادر کنید تا ظرف حداکثر یک هفته پاک‌سازی شوند.</li>
              <li><strong className="text-slate-200">• دسترسی و اصلاح:</strong> حق دسترسی و درخواست اصلاح اطلاعات نادرست برای شما محفوظ است.</li>
              <li><strong className="text-slate-200">• پس از اتمام اشتراک:</strong> داده‌های اصلی کمتر از ۲۴ ساعت پس از ترک سرویس حذف شده و لاگ‌های سیستمی حداکثر تا ۶۰ روز نگهداری می‌شوند.</li>
            </ul>
          </section>
