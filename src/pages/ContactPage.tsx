  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-vazir dir-rtl selection:bg-brand-500 selection:text-white">
      <SEO
        ...
        description="ارتباط با پشتیبانی سامانه شاپیک از طریق تلگرام، اینستاگرام و ایمیل جهت خرید و تمدید اشتراک، دریافت راهنمایی و کسب اطلاعات بیشتر."
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full space-y-10">
        ...
        {/* Support Direct Contact Cards (Telegram, Instagram & Email) - Light Theme */}
