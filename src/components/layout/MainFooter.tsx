...
import { Shield, BarChart3, Bot, FileText, ArrowUpLeft, MessageSquare } from 'lucide-react';
    ...
    <footer className="w-full bg-slate-950 text-slate-400 border-t border-slate-800 font-vazir dir-rtl">
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          {/* Legal & Security */}
          <div className="space-y-3">
            <h3 className="text-sm font-bold text-white tracking-wide border-b border-slate-800 pb-2">ارتباط با پشتیبانی</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              برای تمدید و خرید اشتراک، دریافت راهنمایی فنی و کسب اطلاعات بیشتر می‌توانید با شناسه ShopeekApp@ در تلگرام و اینستاگرام با ما در ارتباط باشید.
            </p>
            <div className="pt-1">
              <Link
                to="/contact"
              ...
              >
                <span>صفحه تماس با پشتیبانی</span>
        ...
        <div className="pt-8 border-t border-slate-800/80 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-6">
            <Link to="/contact" className="hover:text-slate-300 transition-colors">تماس با ما</Link>
