          ...
          <AreaChart data={formattedData} margin={{ top: 5, right: isMobile ? 0 : 10, left: isMobile ? -15 : -20, bottom: 0 }}>
            <defs>
              <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#00ceab" stopOpacity={0.4}/>
                <stop offset="95%" stopColor="#00ceab" stopOpacity={0.0}/>
              </linearGradient>
              <linearGradient id="colorForecast" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#259def" stopOpacity={0.3}/>
                <stop offset="95%" stopColor="#259def" stopOpacity={0.0}/>
              </linearGradient>
            </defs>
            <CartesianGrid
              strokeDasharray="3 3"
