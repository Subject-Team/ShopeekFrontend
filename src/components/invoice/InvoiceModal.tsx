    ...
    <ModalOverlay onClick={onClose}>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
        <div className="w-full max-w-2xl max-h-[90vh] mx-4 pointer-events-auto rounded-3xl shadow-2xl overflow-hidden flex flex-col bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
          {/* Modal Header */}
          <div className="p-4 sm:p-6 border-b border-indigo-100 dark:border-indigo-900/40 flex items-center justify-between bg-gradient-to-br from-indigo-50/70 via-white to-blue-50/50 dark:from-slate-900 dark:via-slate-900 dark:to-indigo-950/40">
            <div className="flex items-center gap-2.5 sm:gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-brand-500 text-white flex items-center justify-center shadow-lg shadow-brand-500/25 shrink-0">
          ...
          {/* Modal Body */}
          <div className="p-4 sm:p-6 lg:p-8 overflow-y-auto space-y-6 flex-1 bg-gradient-to-br from-indigo-50/30 via-white to-blue-50/30 dark:from-slate-900 dark:via-slate-900 dark:to-indigo-950/20">
        {loading ? (
